...
export class init1647668392782 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "ticker" ("id" SERIAL NOT NULL, "symbol" character varying NOT NULL, "figi" character varying NOT NULL, "companyName" character varying NOT NULL, CONSTRAINT "PK_cdb1814b8bc63df6e8be5736bc8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "ticker_bag" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "ownerId" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_2d9500feb0dc929f8a2f61c2ca5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "preferredCurrency" "public"."user_preferredcurrency_enum" NOT NULL DEFAULT 'usd', "preferredLanguage" "public"."user_preferredlanguage_enum" NOT NULL DEFAULT 'ru', "email" character varying NOT NULL, "passwordHash" character varying NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "dividend_history" ("id" SERIAL NOT NULL, "tickerId" integer, "dividendRate" numeric NOT NULL, "dividendExDate" date NOT NULL, "paymentDate" date NOT NULL, "recordDate" date NOT NULL, "indicatedAnnualDividend" date NOT NULL, "announcementDate" date NOT NULL, CONSTRAINT "PK_d39e0167c4e51eabca8430059aa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "ticker_bag_to_ticker" ("tickerBagId" integer NOT NULL, "tickerId" integer NOT NULL, CONSTRAINT "PK_210dcdc826b0bb3f850cc4587a5" PRIMARY KEY ("tickerBagId", "tickerId"))`,
    );
    await queryRunner.query(
